...
fn index_path() -> std::path::PathBuf {
    ...
    // 4. Dev build: index generated by ubuntu-docs-indexer at its default output path.
    // Run: cargo run -p ubuntu-docs-indexer -- --output <path>, then set
    // UBUNTU_HELP_INDEX_PATH, or place the result at target/index.lance here.
    std::path::PathBuf::from(concat!(env!("CARGO_MANIFEST_DIR"), "/target/index.lance"))
}
